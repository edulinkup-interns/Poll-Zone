...
The application is designed to work completely inside the browser using the LocalStorage API, making it fully offline-capable and easy to deploy on static hosting platforms such as GitHub Pages and Netlify.
...
📂 Project Structure : PollZone/ │ ├── index.html ├── style.css ├── app.js ├── assets/ ├── README.md └── screenshots/
